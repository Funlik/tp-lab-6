...
TEST(Lab6Test5, TeamLeaderTest) {
	...
	((TeamLeader*)teamleader)->AddProgrammer(programmer1);
	((TeamLeader*)teamleader)->AddProgrammer(programmer2);
...
TEST(Lab6Test7, ProjectManagerTest) {
	...
	((ProjectManager*)projectmanager)->AddManager(manager1);
	((ProjectManager*)projectmanager)->AddManager(manager2);
...
TEST(Lab6Test8, SeniorManagerTest) {
	...
	((SeniorManager*)seniormanager)->AddProjMan(prmanager1);
	((SeniorManager*)seniormanager)->AddProjMan(prmanager2);
