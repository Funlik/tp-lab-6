...
TEST(CreateTester, TesterTests)
{
    ...
    EXPECT_EQ(TesterBase, tester.GetBase());
    EXPECT_EQ(10000, tester.GetBudget());
    EXPECT_FLOAT_EQ(0.05, tester.GetShare());
}
...
TEST(CalculateSalary, TesterTests)
{
    ...
    EXPECT_EQ(TesterBase * 100, tester.CalculateWorkTimeSalary());
    EXPECT_EQ((int32_t)(10000 * 0.05), tester.CalculateProjectSalary());
    EXPECT_EQ(TesterBase * 100 + (int32_t)(10000 * 0.05), tester.CalculateSalary());
}
